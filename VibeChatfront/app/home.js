    ...
    <LinearGradient colors={["white", "white"]} style={stylesheet.view1}>
      <View style={stylesheet.view3}>
        <View style={stylesheet.view4}>
          <Text style={stylesheet.text2}>Chats</Text>
            <Image source={homeChatIcon} style={stylesheet.image3} />
        </View>
        <Pressable
          ...
          >
            ...
            <View style={stylesheet.view6}>
              ...
              <View style={stylesheet.view8}>
                ...
                <FontAwesome6
                  name={"check"}
                  color={item.chat_status == 1 ? "green" : "grey"}
                  size={11}
      ...
      <View style={stylesheet.view2}>
        <Pressable style={stylesheet.view10}>
          <Image source={bottomChatIcon} style={stylesheet.image4}/>
        </Pressable>
        <Pressable style={stylesheet.view11}  onPress={()=>{
          router.push("/users");
        }} >
